...
def nn_setup(structure= 'densenet121', dropout = 0.5, hidden_layer1 = 120, lr = 0.001, power = 'gpu'):
    if structure == 'vgg16':
        ...
        print("{} is not a valid model. Did you mean vgg16, densenet121, or alexnet ?".format(sturcture))
...
def train_network(model, criterion, optimizer, epochs = 3, print_every = 20, power = 'gpu'):
    ...
    print("The Ultimate NN machine trained your model (As required) ")
    print("-----Epochs: {} -----".format(epochs))
    print("-----Steps: {} -----".format(steps))
    print("That's a lots of steps")
...
print("Now all Model is Trained :) ")
