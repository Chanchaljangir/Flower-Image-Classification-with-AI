...
ap.add_argument('checkpoint',default = '/home/workspace/aipnd-project/checkpoint.pth',nargs= "*", action = "store")
ap.add_argument('--top_k',default = 5, dest= "top_k", action ="store", type= int)
ap.add_argument('--category_names',dest="category_name",action = "store", default = 'cat_to_name.json')
...
def predict(image_path, model, topk= 5, power = 'gpu'):
    ...
    if power == 'gpu':
        ...
        with torch.no_grad():
            outout = model,forward(img_torch)
